...
procedure MixedScheduling is
   ...
   Calibrator: constant Integer := 1100; -- Calibration for correct timing ==> Change parameter for your architecture!
   ...
   task type Background_T(Id : Integer; Prio : Integer; Phase : Integer; Computation_Time : Integer) is
      pragma Priority(Prio); -- A higher number gives a higher priority
   end;
   ...
   Background_Task_1 : Background_T(1, 1, Warm_Up_Time, 100); -- (Id, Prio, Phase, Computation_Time)
   Background_Task_2 : Background_T(2, 1, Warm_Up_Time, 100);
   Background_Task_3 : Background_T(3, 1, Warm_Up_Time, 100);
